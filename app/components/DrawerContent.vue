...
<GridLayout rows="auto, *" class="sidedrawer sidedrawer-left">
            <StackLayout row="0" class="sidedrawer-header">
                ...
                <Label class="sidedrawer-header-brand" text="Javier González"></Label>
                <Label class="footnote" text="juan.gonzalez@neisoft.com.mx"></Label>
            </StackLayout>
            ...
            <ScrollView row="1" class="sidedrawer-content">
                <StackLayout>
                    ...
                    <GridLayout columns="auto, *" :class="'sidedrawer-list-item' + (selectedPage === 'Formas' ? ' selected': '')" @tap="onNavigationItemTap(Formas)">
                        <Label col="0" text.decode="&#xf005;" class="fa"></Label>
                        <Label col="1" text="Formas" class="p-r-10"></Label>
                    </GridLayout>
